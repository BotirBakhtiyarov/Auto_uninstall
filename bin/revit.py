...
def uninstall_autocad():
    ...
    powershell_script = '''
    $application = Get-WmiObject -Class Win32_Product | Where-Object { $_.Name -like "*revit*" }

    if ($application -ne $null) {
        $application.Uninstall()
    } else {
        Write-Host "Revit is not installed."
    }
    '''
...
if __name__ == "__main__":
    print("Starting Revit uninstallation...")
    uninstall_autocad()
    print("Revit uninstallation process completed.")
